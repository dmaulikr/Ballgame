...
-(id) init
{
	...
	if( (self=[super init])) {
		...
		//CCSprite *background = [Sprite spriteWithFile:@"menu_texture.jpg"];
...
//		CCLabel *hScoreLabel = [CCLabel labelWithString:@"High Scores" fontName:@"Marker Felt" fontSize:36];
...
{
	//[[CCDirector sharedDirector] replaceScene:[CCFadeTransition transitionWithDuration:1 scene:[MainMenu scene]]];
}
